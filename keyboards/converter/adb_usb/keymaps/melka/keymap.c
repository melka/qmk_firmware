...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_AEKII_iso_fr(
        KC_ESC,  EMO_NICE, EMO_THIS, EMO_QEQ, EMO_THINKIES,  EMO_100,  EMO_OOF, EMO_HEART, EMO_EYES, EMO_FROGLOVE,EMO_SHARKY, EMO_CLAP, EMO_FLUSHED,                KC_MUTE,KC_VOLD, KC_VOLU,                               MO(_FUNC),
