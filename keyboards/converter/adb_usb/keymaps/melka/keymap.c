...
#define LAYOUT_m0118_iso( \
   ...
   K36,K3A,K37,            K31,        K7C,    K3B,K3C,K3D,   K52,    K41      \
) { \
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUNC] = LAYOUT_m0487_iso( /* Base */
		...
		KC_LCTL, KC_LALT, KC_LGUI,                                KC_SPC,                        KC_ESC,  KC_LEFT, KC_RIGHT,PASS_B,        KC_P0,            KC_PDOT
    ),
};
